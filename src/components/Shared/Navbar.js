...
const Navbar = () => {
  ...
  return (
    <div className={`navbar-container ${navbarClasses.join(" ")}`}>
      <nav
        className="navbar navbar-expand-md  navbar-wrap"
          ...
          <ul className="navbar-nav ml-auto">
            <li className="nav-item">
              <Link
                ...
                to="/"
              >
                <a className="nav-link link mr-2 ml-2" href="home">
            ...
            <li className="nav-item">
              <Link style={{ textDecoration: "none" }} to="/aboutPage">
                <a className="nav-link link mr-2 ml-2" href="aboutPage">
                  About
                </a>
              </Link>
            </li>
            ...
            <li className="nav-item">
              <Link style={{ textDecoration: "none" }} to="/contactPage">
                <a className="nav-link link mr-2 ml-2" href="contactPage">
                  Contact
                </a>
              </Link>
            </li>
            ...
            <li className="nav-item">
              <Link style={{ textDecoration: "none" }} to="/blog">
                <a className="nav-link link mr-2 ml-2" href="blog">
                  Blog
                </a>
              </Link>
            </li>
            <li className="nav-item">
              <a className="nav-link ml-3" href={resumeSrc} download>
                {" "}
                <span className="nav-button "> Resume</span>
              </a>
            </li>
          </ul>
        </div>
